...
from main.util.purgeUtils import CdnPlusPurgeQueryInfo

class PurgeUtilTest(unittest.TestCase):

    def test_makeQueryString(self):
        ...
        query_info = CdnPlusPurgeQueryInfo(cdnInstanceNo, isWholeDomain, domainIdList, 
    ...
    def test_makeQueryString_responseFormatType(self):
        cdnInstanceNo: int = 123456
        isWholeDomain: bool = True
        isWholePurge: bool = False
        domainIdList: list = ["aaa", "bbb"]
    ...
    def test_makeQueryString_required(self):
